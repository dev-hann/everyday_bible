...
class BibleDatabase {
  ...
  WebDataLoader _webDataLoader = WebDataLoader();
   ...
   ValueNotifier<EverydayBible?> bibleNotifier = ValueNotifier(null);
  ...
  set _selectedDateBible(EverydayBible? bible)=>bibleNotifier.value=bible;
  EverydayBible? get selectedDateBible => bibleNotifier.value;

  Future loadData(DateTime dateTime)async{
    EverydayBible? _tmpData =await _hiveDataLoader.bibleFromDate(dateTime);
    if(_tmpData==null){
  ...
  Future updateBible(EverydayBible bible)async{
