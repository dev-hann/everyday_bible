...
class BibleTextSelectionControls extends TextSelectionControls {
  ...
  Widget buildHandle(BuildContext context, TextSelectionHandleType type, double textHeight) {
    ...
    final Color handleColor = Colors.grey;
    ...
    return TextSelectionToolbar(
      ...
      children: itemDatas.asMap().entries.map((MapEntry<int, _TextSelectionToolbarItemData> entry) {
        return TextSelectionToolbarTextButton(
          ...
          child: Text(entry.value.label,style: TextStyle(color: Colors.white),),
        );
      }).toList(),
    );
  }
